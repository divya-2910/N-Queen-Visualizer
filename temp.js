'use strict'
let numberbox = document.getElementById("input-num");
...
playButton.onclick = async function visualise() {
    const chessBoard = document.getElementById("chess-boards");
    const arrangement = document.getElementById("no-of-arrangements");
